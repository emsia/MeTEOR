...
<!---------------PAGE CONTENT-------------------------->	
			...
			<form action="http://localhost/meteor/index.php/validation/search_results" method="post">
				...
				/*drop down menu ko. :(	
				<select class ="textf" name="option">
			...
			<?php echo "<h1>$lastname, $firstname"; ?>
			...
			<?php echo "<table> <tr> <td>Bank name</td>"; ?>
			
			<form action="../validation/payment" method=post>
				<?php echo "<input type='hidden' name='temp' value='".$id."' />"; ?>
				<?php echo "<input type='hidden' name='cbn' value='2' />"; ?>
				<?php echo "<td> <input class ='textf' type='text' name='bankname' required /> </td>"; ?>			
				<?php echo " <td>Bank branch</td>"; ?>
				<?php echo "<td> <input class ='textf' type='text' name='bankbranch' required /> </td>"; ?>
				<?php echo " <td>Transaction ID</td>"; ?>
				<?php echo "<td> <input class ='textf' type='text' name='transaction_id' required /> </td>"; ?>
				<?php echo " <td> <input class='button_login' type='submit' value='Validate' /> 
			</form> </td> </tr> </table>"; ?>
