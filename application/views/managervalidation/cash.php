...
<!---------------PAGE CONTENT-------------------------->	
			...
			<?php echo "<table> <tr> <td> O.R. number </td> <td>"; ?>
			<form action="../validation/payment" method=post>
				<?php echo "<input type='hidden' name='temp' value='".$id."' />"; ?>
				<?php echo "<input type='hidden' name='cbn' value='1' />"; ?>
				<?php echo "<td> <input class ='textf' type='text' name='ornumber' required /> </td>"; ?>
				<?php echo " <td> <input class='button_login' type='submit' value='Validate' /> </form> </td> </tr> </table>"; ?>
