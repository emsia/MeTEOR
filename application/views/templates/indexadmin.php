...
<head>
	...
	<!--[if IE]><link rel="shortcut icon" href="<?php echo base_url('favicon.ico'); ?>"><![endif]-->
	<!-- or, set /favicon.ico for IE10 win -->
	<meta name="msapplication-TileColor" content="#5c0000">
	<meta name="msapplication-TileImage" content="<?php echo base_url('favicon-windows.png'); ?>">
...
<style>
	...
	src: url('<?php echo base_url(); ?>css/fonts/BebasNeue.otf'),
	}

	@font-face
	{
	font-family: Bebas;
	src: url('<?php echo base_url(); ?>css/fonts/Bebas.ttf'),
	}

	@font-face
	{
	font-family: Bellerose;
	src: url('<?php echo base_url(); ?>css/fonts/Bellerose.ttf'),
	}
	...
	src: url('<?php echo base_url(); ?>css/fonts/HWYGOTH.ttf'),
	}
	...
	{
	font-family: calibri;
	src: url('<?php echo base_url(); ?>css/fonts/calibri.ttf'),
	}
...
<body>
	<div class="navbar">
		<div class="container">
			<div id="head" style="background-image: url('<?php echo base_url(); ?>css/images/logos.png');">
			<div id="logo" class="pull-right">
				<img class="pull-right" src="<?php echo base_url(); ?>css/images/logo.png" style="margin-top: -1px;"/> 
			</div>
			<div id="navigation2">
				<div id="navpos">
					<a class="h" href="http://localhost/meteor/index.php/course"> COURSE </a> |
					<a class="h" href="http://localhost/meteor/index.php/managers"> MANAGER </a> |
					<a class="h" href="http://localhost/meteor/index.php/participant"> PARTICIPANT </a>
					
					<a style="font: 12px calibri; color: white;" href="http://localhost/meteor/index.php/participantprofile">Settings</a> 
					<a style="font: 12px calibri;  color: white;" href="http://localhost/meteor/index.php/logout">Logout</a>
				</div>
			</div>
		</div>
	</div>
