...
<div class="span9" style="margin-left: -30px">
	<div class="content">
		...
		<div class="alert alert-danger"><center>SEARCH RESULTS</center></div>
						...
						<div>
							<tr class='linka'>
								<td class="buttontable">
									...
									data-toggle="tooltip" data-trigger="hover" data-placement="top" title data-original-title="Edit" class='btn showMe getAll btn-warning' type='button' name='submit' ><i class="glyphicon glyphicon-pencil"></i></button>								 					
								</td>
								<td class="buttontable">
									<?php 								
									...
									?>
									<button style='padding: 5px'; data-toggle="tooltip" data-trigger="hover" data-placement="top" title data-original-title="Cancel"  onclick="return confirm('Are you sure you want to proceed?')" class='btn btn-danger' type='submit' name='submit' ><i class="glyphicon glyphicon-remove"></i></button>								 					
									<?php															
											echo form_close();
										}	
										else{
									?>
									<button style='padding: 5px'; data-toggle="tooltip" data-trigger="hover" data-placement="top" title data-original-title="Cancel"  class='btn btn-danger' type='submit' name='submit' disable ><i class="glyphicon glyphicon-remove"></i></button>									 					
									<?php } ?>
								</td>	
								<?php
								$temp = strtotime($start[$i]);
			  	...
			  	<tbody>
					<?php for($i=0; $i<$counter; $i++) {?>
						...
						<div>
							...
							?>	
							<td class="dataf"><a href="#"><center><div><?php echo $name[$i]; ?></div></center></a></td>
							<td class="dataf"><center><div><?php echo $description[$i]; ?></div></center></a></td>
							<td class="dataf"><center><div><?php echo $var1; ?></div></center></a></td>
							<td class="dataf"><center><div><?php echo $var2; ?></div></center></a></td>
							<td class="dataf"><center><div><?php echo $venue[$i] ?></div></center></a></td>
							<td class="dataf"><center><div><?php echo $cost[$i]; ?></div></center></td>
							<td class="dataf"><center><div><?php echo $reserved[$i]?> | <?php echo ($available[$i] - ($reserved[$i]+$paid[$i]) ); ?> | <?php echo $paid[$i]; ?></div></center></td>	
							<?php }?>
							</tr>
