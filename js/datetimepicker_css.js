...
var SpanBorderColor = "#810c14";//span border color
var SpanBgColor = "#FFFFFF"; //span background color
var MonthYearColor = "#cc0033"; //Font Color of Month and Year in Calendar header.
var WeekHeadColor = "#5e0000"; //var WeekHeadColor="#18861B";//Background Color in Week header.
...
var WeekDayColor = "#ffe35f"; //Background color of weekdays.
var FontColor = "#FFFFFF"; //color of font in Calendar day cell.
var TodayColor = "#18861B"; //var TodayColor="#FFFF33";//Background color of today.
var SelDateColor = "#8DD59C"; //var SelDateColor = "#8DD53C";//Backgrond color of selected date in textbox.
var YrSelColor = "#cc0033"; //color of font of Year selector.
var MthSelColor = "#cc0033"; //color of font of Month selector if "MonthSelector" is "arrow".
var HoverColor = "#8DD59C"; //color when mouse move over.
var DisableColor = "#ffe35f"; //color of disabled cell.
...
var imageFilesPath = "http://meteor.upsitf.org/js/images/";
...
{ //Generate table cell with value
	...
	if (Cal.ShowTime)
	{
		vTimeStr = 'Hours ' + Cal.Hours + 'Minutes :' + Cal.Minutes;
		if (Cal.ShowSeconds)
		{
...
function RenderCssCal(bNewCal)
{
	...
	if (Cal.ShowTime === true)
	{
		...
		vCalTime += "<td style='color: #cc0033;'>Hrs </td><td width='22px'><input type='text' name='hour' maxlength=2 size=1 style=\"WIDTH:22px\" value=" + showHour + " onkeyup=\"javascript:Cal.SetHour(this.value)\">";
		vCalTime += "<td style='color: #cc0033;'>Min </td><td width='22px'>";
